...
export const editEvent = createAction('[TimeEvent Component] editEvent', (param) => (param));
export const removeEvent = createAction('[TimeEvent Component] removeEvent', (param) => (param));
export const togglePS = createAction('[TimeEvent Component] togglePS', (param) => (param));
